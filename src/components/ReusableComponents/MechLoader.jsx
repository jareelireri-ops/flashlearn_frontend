    ...
    <div className="flex justify-center py-10">
      <style>{`
        .mech-loader {
          ...
          width: ${size}px;
          aspect-ratio: 1;
          animation: mech-loader-0 3s linear infinite;
        }
        .mech-loader:before,
        .mech-loader:after {
          content: "";
        ...
        .mech-loader:before {
          ...
          animation: mech-loader-1 2s linear infinite;
        }
        .mech-loader:after {
          margin: 12.5%;
        ...
        @keyframes mech-loader-0 { to { rotate: 1turn; } }
        @keyframes mech-loader-1 { to { transform: rotate(-1turn) translate(-12.5%) rotate(.75turn); } }
      `}</style>
      <div className="mech-loader" />
    </div>
  )
}
