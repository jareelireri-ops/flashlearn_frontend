...
function DashboardBanner({ user, streak, cardsDue }) {
  ...
  return (
    <div className="bg-slate-900 rounded-2xl px-6 py-5 text-white shadow-xl relative overflow-hidden">
      <div className="absolute top-0 right-0 w-48 h-48 bg-emerald-500/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />
      <div
      ...
      <div className="relative z-10">
        ...
        <h1 className="text-xl font-bold mt-1 uppercase">
          {firstName} — YOU'RE ON A <span className="text-emerald-400">{streak}-DAY STREAK!</span>
        </h1>
