  ...
  return (
    <section className="relative py-20 bg-white border-b border-gray-100 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 text-center">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">Why EcoFlip Works</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 text-left">
          <div role="button" tabIndex={0} className="p-8 bg-emerald-50 rounded-2xl transition-all hover:shadow-lg hover:-translate-y-0.5 cursor-pointer">
            <Brain className="text-emerald-500 mb-4" size={40} />
            <h3 className="font-bold text-xl text-gray-900 mb-2">Active Recall</h3>
            <p className="text-gray-600">Testing yourself forces your brain to recall information, strengthening your memory far better than just re-reading safety manuals.</p>
          </div>
          <div role="button" tabIndex={0} className="p-8 bg-emerald-50 rounded-2xl transition-all hover:shadow-lg hover:-translate-y-0.5 cursor-pointer">
            <Clock className="text-emerald-500 mb-4" size={40} />
            <h3 className="font-bold text-xl text-gray-900 mb-2">Smart Intervals</h3>
            <p className="text-gray-600">Rate how hard a card was. Hard cards reappear sooner, while easy ones are pushed back to match your training pace.</p>
          </div>
          <div role="button" tabIndex={0} className="p-8 bg-emerald-50 rounded-2xl transition-all hover:shadow-lg hover:-translate-y-0.5 cursor-pointer">
            <Zap className="text-emerald-500 mb-4" size={40} />
            <h3 className="font-bold text-xl text-gray-900 mb-2">Train Faster</h3>
            <p className="text-gray-600">Make the most of your corporate training budget by zeroing in on your weak spots and scheming past what your team already knows.</p>
          </div>
        </div>
      </div>
    </section>
